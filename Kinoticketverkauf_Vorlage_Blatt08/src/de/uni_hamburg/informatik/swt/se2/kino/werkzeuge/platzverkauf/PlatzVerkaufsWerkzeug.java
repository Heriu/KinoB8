...
public class PlatzVerkaufsWerkzeug
{
    ...
    //Subwerkzeug
    //private BarbezahlungsWerkzeug _barbezahlungsWerkzeug
    ...
    public PlatzVerkaufsWerkzeug()
    {
        ...
        //Subwerkzeug erstellen
        //_barbezahlungsWerkzeug = new BarbezahlungsWerkzeug();
    }
    ...
    private void aktualisierePreisanzeige(Set<Platz> plaetze)
    {
        if (istVerkaufenMoeglich(plaetze))
        {
            ...
            //_barbezahlungsWerkzeug.setPreis(preis)
        }
